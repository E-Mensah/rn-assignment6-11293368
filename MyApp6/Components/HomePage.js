...
const HomePage = ({ navigation }) => {
  ...
  return (
    <View style={{ backgroundColor: 'white', alignItems: 'center', justifyContent: 'center', width: 393, paddingLeft: 10, paddingRight: 10 }}>
      ...
      <View>
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 37, marginBottom: 25 }}>
          ...
          <View style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: 'white', height: 50, width: 150 }}>
